...
public class ViewFilterAdapter extends RecyclerView.Adapter<ViewFilterAdapter.ViewHolder>{
    private FilterListener mFilterListener;
    private List<Pair<String, PhotoFilter>> mPairList = new ArrayList<>();

    public ViewFilterAdapter(FilterListener filterListener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_filter_view, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Bitmap fromAsset = getBitmapFromAsset(holder.itemView.getContext(), filterPair.getFirst());
        holder.imageFilterView.setImageBitmap(fromAsset);
        holder.txtFilterName.setText(filterPair.getSecond().name().replace("_"," "));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        private ImageView imageFilterView;
        ...
        public ViewHolder(View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mFilterListener.onFilterSelected(mPairList.get(getLayoutPosition()).getSecond());
                }
            });
